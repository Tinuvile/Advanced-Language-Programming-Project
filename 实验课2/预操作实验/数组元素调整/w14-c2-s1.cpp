...
int main(int argc, char** argv)
{
	...
	cout << "请输入数组各元素(正整数),以" << END_NUM << "结束(不含" << END_NUM << "最多" << MAX_N << "个数)" << endl;
	input(a, MAX_N);

	cout << "数组的内容为" << endl;
	output(a, 18); //第2个参数n,表示每n个换行（5-25之间，不考虑n错误）

	adjust(a);
	cout << "调整后数组的内容为" << endl;
	output(a, 14); //第2个参数n,表示每n个换行（5-25之间，不考虑n错误）

	return 0;
}

/*
3 103 123 97 101 87 72 88 74 61 65 2 30 17 19 16 9 9 5 43 2 9 -1
*/