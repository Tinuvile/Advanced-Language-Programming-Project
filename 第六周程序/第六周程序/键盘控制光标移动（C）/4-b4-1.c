...
{
	int choice;
	printf("1.用I、J、K、L键控制上下左右(允许按左箭头时向下移动)，边界停止\n");
	printf( "2.用I、J、K、L键控制上下左右(允许按左箭头时向下移动)，边界回绕\n" );
	printf( "3.用箭头键控制上下左右，边界停止\n" );
	printf( "4.用箭头键控制上下左右，边界回绕\n" );
	printf( "5.用I、J、K、L键控制上下左右(不允许按左箭头时向下移动)，边界停止\n" );
	printf( "6.用I、J、K、L键控制上下左右(不允许按左箭头时向下移动)，边界回绕\n" );
	printf( "0.退出\n" );
	printf( "[请选择0-6]\n");
	choice = _getch();
	return choice;
